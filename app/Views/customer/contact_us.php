...
<div class="container py-5">
  <div class="text-center mb-5">
    ...
    <p class="text-muted">Hubungi atau kunjungi kami untuk menikmati pengalaman terbaik di Paras Selatan Coffee Shop.</p>
  </div>

  <div class="row justify-content-center g-4">
    <div class="col-md-6">
      <div class="card shadow-sm rounded-4 p-4 h-100">
        <h4 class="fw-semibold mb-3">Paras Selatan</h4>
